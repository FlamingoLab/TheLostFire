...
public static class VExtensionMethods
{
	...
	public static Voidless.ValueTuple<A, B> ToValueTuple<A, B>(this Voidless.Tuple<A, B> _tuple) where A : struct where B : struct
	{
		return new Voidless.ValueTuple<A, B>(_tuple.value1, _tuple.value2);
	} 
