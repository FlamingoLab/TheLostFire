...
#region Getters/Setters:
	...
	protected override Vector3 GetOffsetPositionRelativeToTarget(Vector3 _target)
	{
		...
		Vector3 scaledOffset = (displacementOffset.normalized * voidlessCamera.distance * distanceScalar.y);
		Vector3 point = _target + (orbitRotation.rotation * (relativeToTarget ? (voidlessCamera.GetTargetRotation() * scaledOffset) : scaledOffset));
